export default function IconFeatureCard(props) {
  ...
  return (
    <div
      className={`w-full p-0 tablet1:w-[290px] mt-[36px] tablet1:mt-0 desktop1:w-[260px] desktop1:h-[280px] flex flex-col items-center desktop1:hover:scale-110 transition desktop1:p-0 ${className}`}
    >
