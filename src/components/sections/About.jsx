      ...
      <SectionWrapper className="flex flex-col desktop1:flex-row-reverse gap-[40px] desktop1:gap-x-[40px] desktop2:gap-0 desktop1:justify-between">
        <MotionDivDownToUp className=" w-[100%] desktop1:w-[415px] desktop2:w-[485px] flex justify-center">
          <div
            ...
            // }}
            className="shadow-custom-opacity shadow-secondary/25 relative h-auto w-[90%] tablet1:w-full rounded-xl"
          >
            <img
              src={content.texts.about.imagem.img}
              alt=""
              className="shadow-custom-opacity shadow-secondary/25 relative bg-top bg-no-repeat bg-cover h-auto rounded-xl"
            />
            {/* <img
              alt="Imagem de efeito pontilhado"
              src={imgPoints}
              className="absolute opacity-10 right-[-10px] top-[20px] desktop1:right-[-40px] desktop1:top-[40px]"
            ></img> */}
          </div>
          {/* <img
            src={content.texts.about.imagem.img}
