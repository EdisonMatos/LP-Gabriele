...
export default function HeroInfluencer({ appDownloadButtons }) {
  return (
    <div
      className="w-full bg-center bg-repeat font-mainFont bg-gradient-to-b from-black to-bgSectionDark "
      style={{ backgroundImage: `url(${content.texts.hero.backgroundPerson})` }}
      id="home"
    >
      <div className="relative z-10 flex w-full bg-black bg-opacity-0 items-left desktop1:hidden">
